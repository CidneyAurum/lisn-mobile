...
| **队列持久化**(v0.2.2 新增) | ✅ 重启恢复上次播放队列,空播放器点播放自动重播当前曲 |
| **每日推荐一键播放**(v0.2.2 新增) | ✅ 卡片播放键直接搜词播首曲 |
| **歌单批量下载**(v0.2.2 新增) | ✅ 歌单详情下载前 5 首(节流批量入队) |
| **搜索结果平台筛选**(v0.2.2 新增) | ✅ 按来源 chips 一键筛选 |
| **队列自动滚动**(v0.2.2 新增) | ✅ 队列视图打开/切歌时自动滚到当前曲 |
| **音质快切**(v0.2.2 新增) | ✅ 全屏页 128K/320K/SQ 循环,下一首即生效 |
| **发布混淆**(v0.2.2 新增) | ✅ APK 18.2MB → 6.2MB,ProGuard 规则覆盖 QuickJS/序列化 |

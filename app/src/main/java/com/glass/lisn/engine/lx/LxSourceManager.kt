...
val DEFAULT_LX_SOURCES = listOf(
    ...
    LxSourceEntry("changqing", "长青 SVIP 音源", enabled = true, repo = "pdone/lx-music-source", file = "changqing/latest.js", branch = "main",
    ...
    LxSourceEntry("lx", "独家音源", enabled = true, repo = "pdone/lx-music-source", file = "lx/latest.js", branch = "main",
    ...
    LxSourceEntry("huanyin", "幻音音源", enabled = true, repo = "pdone/lx-music-source", file = "huanyin/latest.js", branch = "main",
    ...
    LxSourceEntry("juhe", "聚合 API 音源", enabled = true, repo = "pdone/lx-music-source", file = "juhe/latest.js", branch = "main",
